    ...
    >
      <div className=" container">
        <div className=" grid grid-cols-5 gap-3 place-items-center opacity-50">
          <img className=" w-[80px] dark:invert" src={brand1} />
          <img className=" w-[80px] dark:invert" src={brand2} />
          <img className=" w-[80px] dark:invert" src={brand3} />
          <img className=" w-[80px] dark:invert" src={brand4} />
          <img className=" w-[80px] dark:invert" src={brand5} />
        </div>
      </div>
    </div>
  );
